...
RcppExport SEXP _uRF_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _uRF_randomObsNode(SEXP groupsSEXP, SEXP ySEXP, SEXP inbag_countsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_uRF_rangerCpp", (DL_FUNC) &_uRF_rangerCpp, 47},
    {"_uRF_numSmaller", (DL_FUNC) &_uRF_numSmaller, 2},
    {"_uRF_randomObsNode", (DL_FUNC) &_uRF_randomObsNode, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_uRF(DllInfo *dll) {
