...
ranger <- function(formula = NULL, data = NULL, num.trees = 500, mtry = NULL,
                   ...
                   classification = NULL, x = NULL, y = NULL, clustering = FALSE, ...) {
  ...
  if (is.factor(y) || is.logical(y)) {
    ...
    treetype <- 0 # Clustering mode
    print("Tree type in Clustering Mode")
